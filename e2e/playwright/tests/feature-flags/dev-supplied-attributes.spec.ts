 ...
 *
 * Ported near-verbatim to bridge-react from bridge-nextjs/bridge-svelte's
 * dev-supplied-attributes.spec.ts. Only the framework wrapper differs — the
 * demo route, testids, and assertions are identical.
 *
 * Exercises the path:
