 ...
 *
 * Mirrors bridge-svelte's `shared/allowed-origins.ts`. Defined here rather
 * than imported from auth-core, whose export only exists from TBP-669 on — an
 * app on an older auth-core in the peer range must still build.
 */
