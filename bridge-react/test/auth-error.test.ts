 ...
 * Runs against the auth-core this workspace installs (published 0.7.0-beta.0),
 * which predates the `ORIGIN_NOT_ALLOWED` code — i.e. the plain-HttpError path
 * older apps hit.
 */
...
import {
  ...
  authErrorMessage,
  isOriginNotAllowed,
} from '../src/components/sdk-auth/shared/auth-error';
import { ALLOWED_ORIGINS_ADMIN_PATH, ORIGIN_NOT_ALLOWED_DOCS_URL } from '../src/utils/allowed-origins';
